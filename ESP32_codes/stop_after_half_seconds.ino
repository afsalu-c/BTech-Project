...
unsigned long last_cmd_vel_time = 0;  // ✅ Declare globally
...
void cmd_vel_callback(const void * msgin) {
  ...
  last_cmd_vel_time = millis();  // ✅ Track last command time
}
...
void setup() {
  ...
  last_cmd_vel_time = millis();  // ✅ Initialize at startup
...
void loop() {
  ...
  switch (state) {
    ...
    case AGENT_CONNECTED:
      ...
      // ✅ Stop motors if no cmd_vel received for >500 ms
